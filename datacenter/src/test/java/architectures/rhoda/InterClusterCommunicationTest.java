...
public class InterClusterCommunicationTest {
  ...
  private InterClusterCommunication interClusterCommunication;
  ...
  public void testRackToClusterHeadTx() {
    ...
    interClusterCommunication = new InterClusterCommunication(scheduler, dataCenterRHODA, paths);
